  ...
  function srcAppPagesCharactersCharactersPageTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var CharactersPage = /*#__PURE__*/function () {
      function CharactersPage(router, api) {
        ...
        this.router = router;
        this.api = api; //We need an array of characters, so we create an array
      ...
      _createClass(CharactersPage, [{
        ...
        key: "openCharacters",
        value: function openCharacters(event) {
          var _this = this;
          ...
          this.api.getCharacters(this.offset).subscribe(function (data) {
            ...
            console.log(data);
            _this.characters = _this.characters.concat(data); //Once the array is populated, the event is completed
        ...
        value: function loadMore(event) {
          ...
          this.offset = this.offset + 20; //as soon as the offset has been updated, run the method again

          this.openCharacters(event); //Method for when the number of characters is the limit
