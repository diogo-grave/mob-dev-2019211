  ...
  function srcAppServicesApiServiceTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var ApiService = /*#__PURE__*/function () {
      ...
      _createClass(ApiService, [{
        ...
        key: "getCharacters",
        value: function getCharacters(chars) {
          return this.http.get("https://www.breakingbadapi.com/api/characters?limit=20&offset=".concat(chars));
        }
      }, {
        key: "getCharacter",
        ...
        key: "searchQuote",
        value: function searchQuote(name) {
          return this.http.get("https://www.breakingbadapi.com/api/quote?author=".concat(name));
        }
      }]);
